			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jogovelha-display": {
								"semanticObject": "jogovelha",
								"action": "display",
								"description": "Semana Programador SAP Fiori do zero",
								"title": "Jogo da velha com IA",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jogovelha",
									"url": sap.ui.require.toUrl("jogovelha")
								}
							}
						}
					}
